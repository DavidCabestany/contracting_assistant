...
bedrock_agent_runtime = boto3.client(service_name="bedrock-agent-runtime",config=boto_config)
bedrock_client = boto3.client("bedrock-runtime", region_name=REGION_ID, config=boto_config)
...
def get_mapping_list():    
    ...
    return {
        "question_ls": question_category_ls,
        "prompt_ls": map_prompt_ls
    }
